...
let SlimeRushScene = new Phaser.Class({
    ...
    preload: function () {
        ...
        this.load.glsl('vortex', "./shaders/vortex.frag");
    ...
    create: function () {
        ...
        this.vortex1 = this.add.shader('vortex', 0, 0, 10000, 10000);
        this.vortex1.setUniform('width.value', 16.0);
        this.vortex1.setUniform('height.value', 16.0);
        this.vortex1.setUniform('left.value', 100.0);
        this.vortex1.setUniform('top.value', 310.0);
        this.vortex1.setUniform('alpha.value', 1.0);
        this.vortex1.setUniform('beta.value', 1.0);
        this.vortex1.setDepth(2);

        this.vortex2 = this.add.shader('vortex', 0, 0, 10000, 10000);
        this.vortex2.setUniform('width.value', 16.0);
        this.vortex2.setUniform('height.value', 16.0);
        this.vortex2.setUniform('left.value', 650.0);
        this.vortex2.setUniform('top.value', 310.0);
        this.vortex2.setUniform('alpha.value', 1.0);
        this.vortex2.setUniform('beta.value', 1.0);
        this.vortex2.setDepth(2);

        this.portal = this.add.shader('example', 0, 0, 10000, 10000);
        this.portal.setUniform('centerX.value', 390.0);
        this.portal.setUniform('centerY.value', 320.0);
        this.portal.setUniform('radius.value', 70.0);
    },
    update: function () {
        if (this.gameObjects) {
